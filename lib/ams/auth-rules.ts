...
export const amsSectionDomains: Record<AmsSection, AmsDataDomain[]> = {
  ...
  matchHistory: ["technical", "performance"],
...
export const amsRolePolicies: Record<AmsAuthRole, AmsRolePolicy> = {
  ...
  performanceStaff: {
    ...
    deniedDomains: ["financial", "sourceRegistry", "systemSettings"],
    allowedSections: ["load", "development", "bodyComp", "recovery", "biography", "matchHistory", "external", "athleteProfile", "calendar", "resources"],
    maskedFinancialFields: amsFinancialFields,
  ...
  medicalPerformanceStaff: {
    ...
    deniedDomains: ["financial", "sourceRegistry", "systemSettings"],
    allowedSections: ["load", "injury", "development", "bodyComp", "recovery", "biography", "matchHistory", "external", "athleteProfile", "calendar", "resources"],
    maskedFinancialFields: amsFinancialFields,
