...
export const panelCopy = {
  en: {
    ...
    development: {
      ...
      testing: "Testing",
      testingCopy: "CMJ, sprint splits, COD, Yo-Yo, force plate, and gym testing inputs.",
      valdTesting: "VALD Testing Battery",
  ...
  es: {
    ...
    development: {
      ...
      testing: "Pruebas",
      testingCopy: "CMJ, splits de sprint, COD, Yo-Yo, plataforma de fuerza y gimnasio.",
      valdTesting: "Batería de pruebas VALD",
